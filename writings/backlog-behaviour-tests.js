...
(function () {
    ...
    const unboundedBacklogExpectation = [
        ...
        { arrived: 6, capacity: 5, done: 5, backlogSizeAfter: 2 }, // iteration 3
        { arrived: 6, capacity: 6, done: 6, backlogSizeAfter: 2 }, // iteration 4
        { arrived: 4, capacity: 5, done: 5, backlogSizeAfter: 1 }, // iteration 5
    ];

    const boundedBacklogExpectation = [
        { arrived: 5, capacity: 5, done: 5, backlogSizeAfter: 0 }, // iteration 1
        { arrived: 5, capacity: 4, done: 4, backlogSizeAfter: 1 }, // iteration 2
        { arrived: 6, capacity: 5, done: 5, backlogSizeAfter: 1 }, // iteration 3
        { arrived: 6, capacity: 6, done: 6, backlogSizeAfter: 0 }, // iteration 4
        { arrived: 4, capacity: 5, done: 4, backlogSizeAfter: 0 }, // iteration 5
    ];
    ...
    console.log(unboundedBacklog, boundedBacklog)
